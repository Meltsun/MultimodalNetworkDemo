<template>
  ...
  <div class="tab-container">
    ...
    <el-table height="417"  show-summary  border  :data="backgroundTableData" stripe>
    ...
    <div v-if="activeTab === 'protocols'" class="table-container">
      ...
      <el-table height="417" class="custom-table" border :data="protocolsTableData" stripe>
      <!-- "展示各协议组合标签"标签对应的表格列 -->
  ...
  <div v-if="activeTab === 'historyProtocols'" class="table-container">
    <div class="table-wrapper3">
      <el-table height="417" class="custom-table"  border :data="historyTableData"stripe>
      <!-- "展示各协议组合标签"标签对应的表格列 -->
      <el-table-column prop="state" label="阶段" width="75">
      <template slot-scope="scope">
        <div class="state"> {{ scope.row.state}}</div>
