...
net.setIntfPort('s175', 'h169', 4)
net.setIntfPort('s175', 's181', 2)
net.setIntfPort('s181', 's175', 5)
net.setIntfPort('s181', 's183', 2)
net.setIntfPort('s181', 's187', 3)
net.setIntfPort('s181', 's185', 4)
net.setIntfPort('s183', 's181', 5)
net.setIntfPort('s183', 's187', 3)
net.setIntfPort('s185', 's181', 3)
net.setIntfPort('s185', 's187', 5)
net.setIntfPort('s187', 's177', 5)
net.setIntfPort('s187', 's183', 4)
net.setIntfPort('s187', 's181', 3)
net.setIntfPort('s187', 's185', 2)
net.setIntfPort('s177', 'h179', 2)
net.setIntfPort('s177', 's187', 3)
